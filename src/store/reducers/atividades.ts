...
const initialState: AtividadeState = {
  itens: [
    {
      id: 1,
      nomeContato: 'José Dias',
      emailContato: 'ph@hotmail.com',
      phoneContato: '(99)99999-9999'
    },
    {
      id: 2,
      nomeContato: 'Ronaldo de Oliveira',
      emailContato: 'oliveira@hotmail.com',
      phoneContato: '(99)99999-9999'
    },
    {
      id: 3,
      nomeContato: 'Amanda Amorin',
      emailContato: 'amanda@hotmail.com',
      phoneContato: '(99)99999-9999'
    },
    {
      id: 4,
      nomeContato: 'Lucas de Andrade',
      emailContato: 'andrade@outlook.com.br',
      phoneContato: '(99)99999-9999'
    }
  ]
}
